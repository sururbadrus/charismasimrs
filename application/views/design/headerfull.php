...
<head>
    ...
    <link href='<?php echo base_url('assets/plugins/bower_components/responsive-tables/responsive-tables.css');?>' rel='stylesheet'>
...
<div class="ch-container">
    <div class="row">
        ...
        <div id="content" class="col-lg-20 col-sm-12">
            <!-- content starts -->
