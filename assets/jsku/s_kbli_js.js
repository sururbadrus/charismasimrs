		...
		var mygrid42=jQuery("#list242").jqGrid({
					url: base_js+"index.php/s_kbli/view_grid42", 
					datatype: "json", 
					height: "400", 
					//postData: { id: '0' },
					mtype: "POST",
					colNames: ['KODE KBLI','NAMA KBLI'],
					colModel: [
						//{name:'', index:'',width:50,align:'center'},
						{name:'kode_struktur',width:170,index:'kode_struktur',editable:false},
						{name:'nama_struktur',width:350,index:'nama_struktur',editable:false},
